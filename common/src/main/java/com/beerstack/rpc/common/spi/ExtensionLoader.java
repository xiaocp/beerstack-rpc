package com.beerstack.rpc.common.spi;
...
public class ExtensionLoader<T> {
    ...
    private static final String FARPC_DIRECTORY = "META-INF/bs-rpc/";
    ...
    private static <T> boolean withExtensionAnnotation(Class<T> type) {
        return type.isAnnotationPresent(BeerSPI.class);
    }
    ...
    public static <T> ExtensionLoader<T> getExtensionLoader(Class<T> type) {
        ...
        if (!withExtensionAnnotation(type)) {
            throw new IllegalArgumentException("Extension type(" + type +
                    ") is not extension, because WITHOUT @" + BeerSPI.class.getSimpleName() + " Annotation!");
        }
    ...
    private Map<String, Class<?>> loadExtensionClasses() {
        final BeerSPI defaultAnnotation = type.getAnnotation(BeerSPI.class);
